...
abstract class _$AppRouter extends RootStackRouter {
  ...
  final Map<String, PageFactory> pagesMap = {
    ...
    GatheringRouter.name: (routeData) {
      return AutoRoutePage<dynamic>(
        routeData: routeData,
        child: const GatheringScreen(),
      );
    },
...
/// generated route for
/// [GatheringScreen]
class GatheringRouter extends PageRouteInfo<void> {
  const GatheringRouter({List<PageRouteInfo>? children})
      : super(
          GatheringRouter.name,
          initialChildren: children,
        );

  static const String name = 'GatheringRouter';
